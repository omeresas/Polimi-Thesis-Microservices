...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        For applications that use other infrastructures such as Docker Compose, Dapr, and Docker Swarm, we checked if the infrastructure provides service discovery if the application was to be deployed on a multi host platform.

...
\begin{figure}[H]
    ...
    \caption{An Example of an API Gateway Pattern, by Microsoft Docs under CC License}
...
\caption{Possible Use of Event Sourcing Pattern for a Software Version Tracking Application}
